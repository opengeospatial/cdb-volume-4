...
:titletext: Volume 4: OGC CDB Best Practice use of Shapefiles for Vector Data Storage
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/BP/shapefile-guidance/1.1
...
|Internal reference number of this OGC(R) document:    16-070r3
|Version: 1.1
