...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/BP/shapefile-guidance/1.3
|Internal reference number of this OGC(R) document:    16-070r5
|Version: 1.3
